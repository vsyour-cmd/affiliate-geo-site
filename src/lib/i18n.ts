...
const messages = {
  en: {
    ...
    details: 'Product details', vendor: 'Vendor', commission: 'Commission', billing: 'Billing model', conversion: 'Conversion rate', cancellation: 'Cancellation rate', earningsSale: 'Average earnings per sale', earningsClick: 'Earnings per order-form click', approval: 'Affiliate approval', automatic: 'Automatic approval', manual: 'Application required', updated: 'Data updated', resources: 'Official resources', salesPage: 'View official offer', promoMaterials: 'View promotional materials', metricNote: 'Marketplace metrics are historical indicators and may change. Verify current terms with the provider.',
    compare: 'Compare similar products', compareIntro: 'See nearby options side by side before choosing.', currentChoice: 'Current product', alternative: 'Alternative', viewDetails: 'View details', relatedGuides: 'Related guides', relatedGuidesIntro: 'Deeper explanations, use cases, and buying considerations for this product.', readGuide: 'Read guide',
  ...
  zh: {
    ...
    details: '产品数据', vendor: '供应商', commission: '佣金', billing: '结算模式', conversion: '转化率', cancellation: '取消率', earningsSale: '平均每单收益', earningsClick: '每次订单页点击收益', approval: '联盟申请', automatic: '自动批准', manual: '需要申请', updated: '数据更新', resources: '官方资料', salesPage: '查看官方优惠', promoMaterials: '查看推广素材', metricNote: '市场数据是历史参考，可能发生变化，请向供应商核实当前条款。',
    compare: '同类产品对比', compareIntro: '选择前对比同类产品的图片、定位和价格。', currentChoice: '当前产品', alternative: '同类选择', viewDetails: '查看详情', relatedGuides: '相关指南', relatedGuidesIntro: '查看产品使用场景、功能解读和购买注意事项。', readGuide: '阅读指南',
...
const fallbackOverrides: Record<'ja' | 'de' | 'fr', Partial<EnglishMessages>> = {
  ja: {
    ...
    details: '製品データ', vendor: '販売者', commission: 'コミッション', billing: '課金方式', conversion: 'コンバージョン率', cancellation: 'キャンセル率', earningsSale: '1件あたり平均収益', earningsClick: '注文ページクリック収益', approval: '参加承認', automatic: '自動承認', manual: '申請が必要', updated: '更新日', resources: '公式資料', salesPage: '公式オファーを見る', promoMaterials: 'プロモーション素材', metricNote: '数値は過去の指標で変更される場合があります。最新条件は提供元にご確認ください。',
    compare: '類似製品を比較', compareIntro: '画像、特徴、価格を比較して選べます。', currentChoice: '現在の製品', alternative: '代替案', viewDetails: '詳細を見る', relatedGuides: '関連ガイド', relatedGuidesIntro: '機能、利用シーン、購入時のポイントを確認できます。', readGuide: 'ガイドを読む',
  ...
  de: {
    ...
    details: 'Produktdaten', vendor: 'Anbieter', commission: 'Provision', billing: 'Abrechnungsmodell', conversion: 'Conversion-Rate', cancellation: 'Stornoquote', earningsSale: 'Durchschnittlicher Ertrag pro Verkauf', earningsClick: 'Ertrag pro Bestellformular-Klick', approval: 'Affiliate-Freigabe', automatic: 'Automatische Freigabe', manual: 'Bewerbung erforderlich', updated: 'Daten aktualisiert', resources: 'Offizielle Ressourcen', salesPage: 'Offizielles Angebot ansehen', promoMaterials: 'Werbemittel ansehen', metricNote: 'Marktdaten sind historische Kennzahlen und können sich ändern. Aktuelle Bedingungen bitte beim Anbieter prüfen.',
    compare: 'Ähnliche Produkte vergleichen', compareIntro: 'Vergleichen Sie Bilder, Positionierung und Preise vor Ihrer Wahl.', currentChoice: 'Aktuelles Produkt', alternative: 'Alternative', viewDetails: 'Details ansehen', relatedGuides: 'Passende Ratgeber', relatedGuidesIntro: 'Mehr zu Funktionen, Einsatzbereichen und Kaufüberlegungen.', readGuide: 'Ratgeber lesen',
  },
  fr: {
    ...
    details: 'Données produit', vendor: 'Fournisseur', commission: 'Commission', billing: 'Mode de facturation', conversion: 'Taux de conversion', cancellation: 'Taux d’annulation', earningsSale: 'Gain moyen par vente', earningsClick: 'Gain par clic sur la commande', approval: 'Approbation affilié', automatic: 'Approbation automatique', manual: 'Candidature requise', updated: 'Données actualisées', resources: 'Ressources officielles', salesPage: 'Voir l’offre officielle', promoMaterials: 'Voir les supports promotionnels', metricNote: 'Les statistiques sont historiques et peuvent changer. Vérifiez les conditions actuelles auprès du fournisseur.',
    compare: 'Comparer des produits similaires', compareIntro: 'Comparez les visuels, le positionnement et les prix avant de choisir.', currentChoice: 'Produit actuel', alternative: 'Alternative', viewDetails: 'Voir les détails', relatedGuides: 'Guides associés', relatedGuidesIntro: 'Approfondissez les fonctions, les usages et les points à considérer avant l’achat.', readGuide: 'Lire le guide',
  },
}
